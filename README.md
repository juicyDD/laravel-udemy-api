...
2. BUILD
    ...
    - Run command : *`docker-compose exec laravel_app composer install`* for install packeges
    - Run command : *`docker-compose exec laravel_app php artisan key:generate`* for create app key
    - Web service running default on : **localhost:9000**
3. NOTE
    - If wanna to change post of web service, go to file docker-compose.yml and change port of web service
	- If you need to run command line in docker, run this: *`docker exec -it laravel_app bash`*
